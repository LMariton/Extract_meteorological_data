...
#
# metropolitan_France :if TRUE all sites considered are in metropolitan France (and Corsica), only the E-Obs 
# data located in this zone are considered, if FALSE the whole dataset is considered
#
# verbose : if FALSE messages are suppressed

##############################################################################################################

extract_eobs <- function(path_to_meteo_nc,tableDaysSites,nbrPreviousDays,verbose=T){
